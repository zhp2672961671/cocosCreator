System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, sys, log, native, Util, _dec, _class, _class2, _crd, ccclass, property, StorageManager;
    ...
    execute: function () {
      ...
      _export("StorageManager", StorageManager = (_dec = ccclass("StorageManager"), _dec(_class = (_class2 = class StorageManager {
        ...
        save() {
          ...
          native.fileUtils.writeToFile(valueObj, this._getConfigPath());
        }
        /**
         * 获取配置文件路径
         * @returns 获取配置文件路径
...
//# sourceMappingURL=4586b5356118f5e6a4d0abf4ee08502c2bd8c880.js.map