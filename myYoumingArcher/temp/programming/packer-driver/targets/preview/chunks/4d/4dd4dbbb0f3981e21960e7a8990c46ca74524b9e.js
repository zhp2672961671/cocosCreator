System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, EffectManager, Constant, _decorator, Component, Vec3, Quat, tween, Enum, ClientEvent, ResourceUtil, AudioManager, PoolManager, _dec, _dec2, _class, _class2, _descriptor, _crd, REWARD_TYPE, ccclass, property, Reward;
    ...
    execute: function () {
      ...
      _export("Reward", Reward = (_dec = ccclass('Reward'), _dec2 = property({
        ...
        _checkMonsterClearOver() {
          return; // let ndTarget = GameManager.getNearestMonster();
          // if (!ndTarget) {
        ...
        _checkInhaleOver() {
          var arrReward = this._ndParent.children.filter(ndChild => {
            return ndChild.name === "gold" || ndChild.name === "heart";
          });
...
//# sourceMappingURL=4dd4dbbb0f3981e21960e7a8990c46ca74524b9e.js.map