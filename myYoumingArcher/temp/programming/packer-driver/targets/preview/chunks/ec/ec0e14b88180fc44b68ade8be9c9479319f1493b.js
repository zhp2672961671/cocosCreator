System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, sys, native, PlayerData, StorageManager, SdkUtil, _crd;
  ...
  return {
    ...
    execute: function () {
      ...
      __checkObsolete__(['_decorator', 'SpriteFrame', 'sys', 'native']);
        ...
        static vibrateShort() {
          ...
          if (isEnableVibrate) {
            ...
            if (now - this.vibratePreTime >= this.vibrateInterval) {
              if (sys.isNative) {
                native.reflection.callStaticMethod("com/cocos/game/AppActivity", "vibrator", "()V"); //@ts-ignore
              } else if (window.wx) {
                //@ts-ignore
                wx.vibrateShort({
                  success: result => {},
...
//# sourceMappingURL=ec0e14b88180fc44b68ade8be9c9479319f1493b.js.map