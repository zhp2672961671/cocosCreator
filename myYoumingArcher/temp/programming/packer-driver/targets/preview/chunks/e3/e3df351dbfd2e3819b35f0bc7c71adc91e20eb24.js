  ...
  return {
    ...
    execute: function () {
      ...
      _export("EffectManager", EffectManager = (_dec = ccclass('EffectManager'), _dec(_class = (_class2 = class EffectManager {
        ...
        loadAndPlayEffect(isLocal, ndTarget, effectPath, scale, pos, eulerAngles, isPlayAnimation, isPlayParticle, speed, isRecycle, recycleTime, callback) {
          if (isLocal === void 0) {
            isLocal = true;
          }
          ...
          (_crd && ResourceUtil === void 0 ? (_reportPossibleCrUseOfResourceUtil({
            ...
            var ndParent = isLocal ? ndTarget : this.ndParent;
        ...
        playEffect(ndEffect, isPlayAnimation, isPlayParticle, speed, isRecycle, recycleTime, callback) {
          if (isPlayAnimation === void 0) {
            isPlayAnimation = true;
          }
          ...
          if (isPlayAnimation) {
            var duration = this.playAnimation(ndEffect, speed, null, false, false, null, null);
            maxDuration = duration > maxDuration ? duration : maxDuration;
          }

          if (isPlayParticle) {
            var _duration = this.playParticle(ndEffect, speed, false, null, null);

            maxDuration = _duration > maxDuration ? _duration : maxDuration;
          }
        ...
        playAnimation(ndEffect, speed, animationName, isLoop, isRecycle, recycleTime, callback) {
          if (speed === void 0) {
            speed = 1;
          }
          ...
          if (arrAni.length) {
            arrAni.forEach((element, idx) => {
              ...
              var aniName = animationName ? animationName : element == null ? void 0 : (_element$defaultClip = element.defaultClip) == null ? void 0 : _element$defaultClip.name;
              ...
              if (aniName) {
                ...
                if (aniState) {
                  ...
                  maxDuration = duration > maxDuration ? duration : maxDuration; // 动画循环模式
        ...
        playParticle(ndEffect, speed, isRecycle, recycleTime, callback) {
          if (speed === void 0) {
            speed = 1;
          }
        ...
        showRewardBounce(ndMonster, modelPath, rewardNum, callback) {
          if (rewardNum === void 0) {
            rewardNum = 1;
          }
...
//# sourceMappingURL=e3df351dbfd2e3819b35f0bc7c71adc91e20eb24.js.map