      ...
      _export("Util", Util = (_dec = ccclass("Util"), _dec(_class = class Util {
        ...
        static getStringLength(render) {
          ...
          for (var i = 0, n = strArr.length; i < n; i++) {
            ...
            var val = strArr.charCodeAt(i); // 当unicode>255，可以判断该字符字节长度为2
        ...
        */
        ...
        static filterDifferentValue(arr1, arr2) {
          var arr = []; // filter创建一个新数组，新数组中元素是通过检查指定数组中符合条件的所有元素
        ...
        */
        ...
        static parseStringData(str, symbol) {
          ...
          var arr = str.split(symbol); // map 循环遍历数组 还回执行结果，不改变原数组
...
//# sourceMappingURL=9838b4e896412cc8aa0d7a74c0ee885c56aa9f92.js.map