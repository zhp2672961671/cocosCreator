import { _decorator, Component, Node, Vec3, Prefab, LabelComponent, NodePool, instantiate, math, AnimationComponent } from 'cc';
...
export class GameManager extends Component {
    ...
    createStraitFloor(pos: Vec3) {
        ...
        // console.log("pos============================",straitFloorNode.position)
