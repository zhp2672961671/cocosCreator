System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      __checkObsolete__(['_decorator', 'Component', 'Node', 'Vec3', 'CCFloat', 'input', 'Input', 'SkeletalAnimationComponent', 'AudioClip', 'AudioSourceComponent', 'AnimationComponent', 'systemEvent', 'SystemEvent', 'EventTouch', 'tween', 'ITriggerEvent']);
      ...
      _export("PlayerController", PlayerController = (_dec = ccclass('PlayerController'), _dec2 = property({
        ...
        onGamePlaying() {
          ...
          var jumpState = this.playerAnimComp.getState(cocosAnim.jump); // 注册监听
...
//# sourceMappingURL=182b3958f8a5f49e838759800b9bd661c0f06272.js.map