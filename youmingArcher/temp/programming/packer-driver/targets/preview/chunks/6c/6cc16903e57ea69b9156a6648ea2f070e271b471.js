  ...
  return {
    ...
    execute: function () {
      ...
      _export("Player", Player = (_dec = ccclass('Player'), _dec2 = property(_crd && PlayerModel === void 0 ? (_reportPossibleCrUseOfPlayerModel({
        ...
        _parsePlayerSkill(isCoverSkill) {
        ...
        _onPlayerStopMove() {
          if (!(_crd && GameManager === void 0 ? (_reportPossibleCrUseOfGameManager({
            ...
            if ((_crd && GameManager === void 0 ? (_reportPossibleCrUseOfGameManager({
              ...
              var isMonsterSurvive = (_crd && GameManager === void 0 ? (_reportPossibleCrUseOfGameManager({
                error: Error()
        ...
        _initArrow(arrowName) {
          (_crd && ResourceUtil === void 0 ? (_reportPossibleCrUseOfResourceUtil({
            ...
            var playerWorPos = this.node.worldPosition;
        ...
        preloadArrow(callback) {
          ...
          var loadArrow = (arrowName, arrowItemNum) => {
            return new Promise((resolve, reject) => {
              if (this._arrArrowPreload.indexOf(arrowName) == -1) {
                ...
                var p1 = (_crd && GameManager === void 0 ? (_reportPossibleCrUseOfGameManager({
                  error: Error()
                }), GameManager) : GameManager).preloadArrowEffects(arrowItemNum * groupNum);
                var p2 = (_crd && GameManager === void 0 ? (_reportPossibleCrUseOfGameManager({
                  error: Error()
...
//# sourceMappingURL=6cc16903e57ea69b9156a6648ea2f070e271b471.js.map