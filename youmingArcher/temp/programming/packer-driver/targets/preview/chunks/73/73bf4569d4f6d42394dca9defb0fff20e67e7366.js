      ...
      _export("MapManager", MapManager = (_dec = ccclass('MapManager'), _dec(_class = (_class2 = class MapManager extends Component {
        ...
        buildMap(mapName, progressCb, completeCb) {
          ...
          var cb = () => {
            ...
            for (var i = this._arrMap.length - 1; i >= 0; i--) {
              var item = this._arrMap[i];
              var baseInfo = (_crd && LocalConfig === void 0 ? (_reportPossibleCrUseOfLocalConfig({
                error: Error()
            ...
            for (var _i in this._dictModuleType) {
              var _item = this._dictModuleType[_i];

              if (_item.length) {
                arrPromise.push(this._buildModel(_i));
              }
            }
        ...
        _buildModel(type) {
          ...
          return new Promise((resolve, reject) => {
            var arrPromise = [];
            var objItems = this._dictModuleType[type]; //同类型的信息
            ...
            var _loop = function _loop(idx) {
              ...
              var p = (_crd && ResourceUtil === void 0 ? (_reportPossibleCrUseOfResourceUtil({
                ...
                var ndParent = _this.node.getChildByName(parentName);

                if (!ndParent) {
                  ndParent = new Node(parentName);
                  ndParent.parent = _this.node;
                }

                var ndChild = (_crd && PoolManager === void 0 ? (_reportPossibleCrUseOfPoolManager({
                  error: Error()
                ...
                if (baseInfo.type === (_crd && Constant === void 0 ? (_reportPossibleCrUseOfConstant({
                  ...
                  var scriptMonster = ndChild == null ? void 0 : ndChild.getComponent(_crd && Monster === void 0 ? (_reportPossibleCrUseOfMonster({
                    error: Error()
                  }), Monster) : Monster);
...
//# sourceMappingURL=73bf4569d4f6d42394dca9defb0fff20e67e7366.js.map