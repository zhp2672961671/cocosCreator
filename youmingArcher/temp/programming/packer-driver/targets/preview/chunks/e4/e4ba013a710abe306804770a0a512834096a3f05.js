    ...
    execute: function () {
      ...
      _export("Arrow", Arrow = (_dec = ccclass('Arrow'), _dec(_class = class Arrow extends Component {
        ...
        */
        ...
        init(speed, releaseWorPos, isPreload) {
          if (isPreload === void 0) {
            isPreload = false;
          }
        ...
        hideArrow() {
          ...
          var isAllArrowHide = (_this$node$parent = this.node.parent) == null ? void 0 : _this$node$parent.children.every(ndArrow => {
        ...
        _onTriggerEnterCb(event) {
          ...
          if (otherCollider.getGroup() === (_crd && Constant === void 0 ? (_reportPossibleCrUseOfConstant({
            ...
            var scriptMonster = ndMonster.getComponent(_crd && Monster === void 0 ? (_reportPossibleCrUseOfMonster({
              error: Error()
            }), Monster) : Monster);
...
//# sourceMappingURL=e4ba013a710abe306804770a0a512834096a3f05.js.map