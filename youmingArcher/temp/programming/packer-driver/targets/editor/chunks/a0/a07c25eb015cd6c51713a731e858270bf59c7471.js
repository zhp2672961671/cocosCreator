      ...
      _export("Monster", Monster = (_dec = ccclass('Monster'), _dec2 = property(Material), _dec3 = property(Material), _dec4 = property(SkinnedMeshRenderer), _dec(_class = (_class2 = class Monster extends Component {
        ...
        playHit(isArrowLaunch = false, isPassiveLightning = false) {
          ...
          if (Math.random() > this.baseInfo.dodgeRate) {
            ...
            let damage = (_crd && GameManager === void 0 ? (_reportPossibleCrUseOfGameManager({
              error: Error()
            ...
            let isCriticalHit = Math.random() <= (_crd && GameManager === void 0 ? (_reportPossibleCrUseOfGameManager({
              error: Error()
        ...
        */
        ...
        playAttackAni() {
          let attackAniName = (_crd && Constant === void 0 ? (_reportPossibleCrUseOfConstant({
            error: Error()
        ...
        _moveToRandomPos() {
          ...
          let x = (_crd && Util === void 0 ? (_reportPossibleCrUseOfUtil({
            error: Error()
          }), Util) : Util).getRandom(1, 3) * (_crd && Util === void 0 ? (_reportPossibleCrUseOfUtil({
            error: Error()
          }), Util) : Util).getRandomDirector();
          let z = (_crd && Util === void 0 ? (_reportPossibleCrUseOfUtil({
            error: Error()
          }), Util) : Util).getRandom(1, 3) * (_crd && Util === void 0 ? (_reportPossibleCrUseOfUtil({
            error: Error()
          }), Util) : Util).getRandomDirector();
        ...
        _stayRotateAttack() {
          let angleY = this._getTwoPosAngleY(this.node.worldPosition, (_crd && GameManager === void 0 ? (_reportPossibleCrUseOfGameManager({
            error: Error()
          }), GameManager) : GameManager).ndPlayer.worldPosition);
...
//# sourceMappingURL=a07c25eb015cd6c51713a731e858270bf59c7471.js.map