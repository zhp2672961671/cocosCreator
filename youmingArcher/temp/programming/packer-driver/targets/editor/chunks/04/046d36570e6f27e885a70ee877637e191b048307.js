    ...
    execute: function () {
      ...
      _export("FightTip", FightTip = (_dec = ccclass('FightTip'), _dec(_class = class FightTip extends Component {
        ...
        show(scriptParent, tipType, bloodNum, callback) {
          ...
          let lbHitNum = (_ndSub$getChildByName = ndSub.getChildByName('num')) == null ? void 0 : _ndSub$getChildByName.getComponent(LabelComponent);
          lbHitNum && (lbHitNum.string = txt);
          ndSub.active = true;
          let pos = this.node.getPosition();
          let width = (_ndSub$getComponent = ndSub.getComponent(UITransformComponent)) == null ? void 0 : _ndSub$getComponent.width;
          let height = (_ndSub$getComponent2 = ndSub.getComponent(UITransformComponent)) == null ? void 0 : _ndSub$getComponent2.height;
...
//# sourceMappingURL=046d36570e6f27e885a70ee877637e191b048307.js.map