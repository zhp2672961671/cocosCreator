      ...
      _export("GameManager", GameManager = (_dec = ccclass('GameManager'), _dec2 = property(_crd && GameCamera === void 0 ? (_reportPossibleCrUseOfGameCamera({
        ...
        _createPlayer() {
          (_crd && ResourceUtil === void 0 ? (_reportPossibleCrUseOfResourceUtil({
            ...
            let scriptGameCamera = (_GameManager$mainCame = GameManager.mainCamera) == null ? void 0 : _GameManager$mainCame.node.getComponent(_crd && GameCamera === void 0 ? (_reportPossibleCrUseOfGameCamera({
              error: Error()
            }), GameCamera) : GameCamera);
            scriptGameCamera.ndFollowTarget = GameManager.ndPlayer;
            let scriptPlayer = (_GameManager$ndPlayer = GameManager.ndPlayer) == null ? void 0 : _GameManager$ndPlayer.getComponent(_crd && Player === void 0 ? (_reportPossibleCrUseOfPlayer({
              error: Error()
            }), Player) : Player);
        ...
        static getNearestMonster() {
          if (GameManager.arrMonster.length) {
            let arr = GameManager.arrMonster.sort((a, b) => {
              let distanceA = (_crd && Util === void 0 ? (_reportPossibleCrUseOfUtil({
                error: Error()
              }), Util) : Util).getTwoNodeXZLength(GameManager.ndPlayer, a);
              let distanceB = (_crd && Util === void 0 ? (_reportPossibleCrUseOfUtil({
                error: Error()
...
//# sourceMappingURL=9cf8279c72a628f6b4d5092cea8969b5e421f0c0.js.map