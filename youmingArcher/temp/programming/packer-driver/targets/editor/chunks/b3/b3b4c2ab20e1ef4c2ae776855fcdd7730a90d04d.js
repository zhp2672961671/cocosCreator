          ...
          if (otherCollider.getGroup() === (_crd && Constant === void 0 ? (_reportPossibleCrUseOfConstant({
            ...
            switch (this.colliderName) {
              ...
              case COLLIDER_NAME.FIRE_BALL:
                ...
                scriptSkillCollider = (_this$node$parent2 = this.node.parent) == null ? void 0 : _this$node$parent2.getComponent(_crd && FireBall === void 0 ? (_reportPossibleCrUseOfFireBall({
                  error: Error()
                }), FireBall) : FireBall);
              ...
              case COLLIDER_NAME.TORNADO:
                scriptSkillCollider = (_this$node$parent3 = this.node.parent) == null ? void 0 : _this$node$parent3.getComponent(_crd && Tornado === void 0 ? (_reportPossibleCrUseOfTornado({
                  error: Error()
                }), Tornado) : Tornado);
              ...
              case COLLIDER_NAME.FIRE_BALL_BIG:
                scriptSkillCollider = (_this$node$parent4 = this.node.parent) == null ? void 0 : _this$node$parent4.getComponent(_crd && FireBallBig === void 0 ? (_reportPossibleCrUseOfFireBallBig({
                  error: Error()
              ...
              case COLLIDER_NAME.LASER:
                scriptSkillCollider = (_this$node$parent5 = this.node.parent) == null ? void 0 : _this$node$parent5.getComponent(_crd && Laser === void 0 ? (_reportPossibleCrUseOfLaser({
                  error: Error()
                }), Laser) : Laser);
        ...
        update(deltaTime) {
          ...
          if (this.colliderName === COLLIDER_NAME.JET_FIRES && this._isOnJetFires) {
            ...
            if (this._checkInterval >= 0.5) {
              ...
              let scriptSkillCollider = this.node.parent.getComponent(_crd && JetFires === void 0 ? (_reportPossibleCrUseOfJetFires({
                error: Error()
              }), JetFires) : JetFires);
...
//# sourceMappingURL=b3b4c2ab20e1ef4c2ae776855fcdd7730a90d04d.js.map