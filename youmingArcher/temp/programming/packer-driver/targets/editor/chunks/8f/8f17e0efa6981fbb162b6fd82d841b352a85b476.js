        ...
        show(callback) {
          ...
          this.ndSkills.children.forEach((ndChild, idx, arr) => {
            if (arrLock[idx]) {
              ...
              ndChild.active = true;
              let scriptItem = ndChild.getComponent(_crd && SkillItem === void 0 ? (_reportPossibleCrUseOfSkillItem({
                error: Error()
              }), SkillItem) : SkillItem);
...
//# sourceMappingURL=8f17e0efa6981fbb162b6fd82d841b352a85b476.js.map