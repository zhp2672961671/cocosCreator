  ...
  return {
    ...
    execute: function () {
      ...
      _export("SkillList", SkillList = (_dec = ccclass('SkillList'), _dec2 = property(Prefab), _dec(_class = (_class2 = class SkillList extends Component {
        ...
        init(callback) {
          let arrUnLockSkill = (_crd && PlayerData === void 0 ? (_reportPossibleCrUseOfPlayerData({
            error: Error()
          ...
          arrUnLockSkill.forEach((skillInfo, idx) => {
            ...
            ndChild.active = true;
            let itemInfo = (_crd && LocalConfig === void 0 ? (_reportPossibleCrUseOfLocalConfig({
              error: Error()
            }), LocalConfig) : LocalConfig).instance.queryByID("playerSkill", arrUnLockSkill[idx]);
            let scriptSkillIcon = ndChild.getComponent(_crd && SkillIcon === void 0 ? (_reportPossibleCrUseOfSkillIcon({
              error: Error()
            }), SkillIcon) : SkillIcon);
...
//# sourceMappingURL=f8c6ed985d473fde2d4b7f7475712dabb311870b.js.map