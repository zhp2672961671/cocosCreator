    ...
    execute: function () {
      ...
      CSV = {
        ...
        parse: function (text, opts, fn) {
          ...
          console.log("parse=============", {}); //  //@ts-ignore忽略设置
          //@ts-ignore

          this.assign({}, this.STANDARD_DECODE_OPTS, opts);
          return false; // opts = this.assign({}, this.STANDARD_DECODE_OPTS, opts);
          //@ts-ignore
...
//# sourceMappingURL=eb176815d95a28196982dba16300a1ca7f277239.js.map