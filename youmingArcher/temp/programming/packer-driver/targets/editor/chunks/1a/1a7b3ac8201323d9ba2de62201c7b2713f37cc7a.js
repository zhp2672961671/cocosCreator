System.register(["cc"], function (_export, _context) {
  ...
  var _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, log, _decorator, _dec, _class, _class2, _crd, ccclass, property, CELL_DELIMITERS, LINE_DELIMITERS, getter, getterCast, CSV, CSVManager;
  ...
  return {
    ...
    execute: function () {
      ...
      __checkObsolete__(['log', '_decorator']);
      ...
      CSV = {
        ...
        parse: function (text, opts, fn) {
          ...
          log("opts==================", opts); //@ts-ignore

          this.opts = opts;

          if (!opts.delimiter || !opts.newline) {
            var limit = Math.min(48, Math.floor(text.length / 20), text.length);
            console.log("mostFrequent============", this.mostFrequent(text, CELL_DELIMITERS, limit), this.mostFrequent(text, LINE_DELIMITERS, limit));
...
//# sourceMappingURL=1a7b3ac8201323d9ba2de62201c7b2713f37cc7a.js.map