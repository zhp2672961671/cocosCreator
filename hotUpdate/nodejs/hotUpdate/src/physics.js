...
var S = cc._decorator, E = S.ccclass, M = S.executeInEditMode, C = S.executionOrder, A = S.menu, z = S.property, F = S.requireComponent, R = S.disallowMultiple, T = cc.Vec3, P = (o = E("cc.ConstantForce"), 
...
displayOrder: 3
}), o(u = n(u = r(u = s(u = R(u = M(u = (p = function(t) {
_(e, t);
function e() {
...
var R = cc._decorator, T = R.ccclass, P = R.disallowMultiple, q = R.executeInEditMode, I = R.executionOrder, V = R.menu, O = R.property, k = cc.Vec3, N = (o = T("cc.RigidBody3D"), 
...
for (var o = t.numObjects(), r = t.bodies, a = this.aabbMax, l = this.aabbMin, h = this.nx, c = this.ny, u = this.nz, p = c * u, d = u, y = 1, f = a.x, v = a.y, m = a.z, g = l.x, w = l.y, b = l.z, x = h / (f - g), _ = c / (v - w), B = u / (m - b), S = (f - g) / h, E = (v - w) / c, M = (m - b) / u, C = .5 * Math.sqrt(S * S + E * E + M * M), A = n.types, z = A.SPHERE, F = A.PLANE, R = (A.BOX, 
...
var a = A, l = q, h = I, c = C, u = z, p = F, y = R, f = P, b = T, x = (s && s.faceList, 
...
var B = new s(), S = new s(), E = (new s(), new s()), M = new s(), C = new s(), A = new s(), z = new s(), F = new s(), R = new s(), T = new s(), P = new s(), q = new s(), I = new s(), V = new i(), O = [];
p.prototype[n.types.SPHERE | n.types.TRIMESH] = p.prototype.sphereTrimesh = function(t, e, i, o, n, s, l, h, c, u, p) {
var d = C, y = A, f = z, v = F, m = R, g = T, w = V, b = M, x = S, _ = O;
...
this.createFrictionEquationsFromContact(q, this.frictionResult);
R = 0;
for (var O = F.length; R !== O; R++) u.release(F[R]);
return;
}
for (R = 0; R !== B.length; R++) {
var k = u.get(), N = u.get();
r.vmult(y[B[(R + 1) % B.length]], k);
r.vmult(y[B[(R + 2) % B.length]], N);
o.vadd(k, k);
o.vadd(N, N);
var j = ot;
N.vsub(k, j);
...
this.result.push(q);
this.createFrictionEquationsFromContact(q, this.frictionResult);
for (R = 0, O = F.length; R !== O; R++) u.release(F[R]);
u.release(k);
u.release(N);
u.release(W);
u.release(G);
